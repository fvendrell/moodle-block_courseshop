...
<p><u>Order Summary</u>
<hr/>
<b>Total Ammount (untaxed):</b> <%%AMOUNT%%><br>
<b>Total taxes:</b> <%%TAXES%%><br>
<b>Total Taxed Amount:</b> <%%TTC%%><br>
<b>Paymode:</b> Mercanet Online Credit Card<br>
<b>Number of items:</b> <%%ITEMS%%>
<hr/>

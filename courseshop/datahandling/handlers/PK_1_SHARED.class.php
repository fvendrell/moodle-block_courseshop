    ...
    function produce_postpay(&$data){
        ...
        foreach($this->courseidnumbers as $courseidnumber){
	        if ($course = get_record('course', 'idnumber', $courseidnumber)){
    			...
    			courseshop_trace("[{$data->transactionid}] Post Pay Process : PK_1_SHARED Failure for course ID number $courseidnumber.");
    	...
    	courseshop_trace("[{$data->transactionid}] Post Pay Process : PK_1_SHARED Completed.");
        return $productiondata;
    }

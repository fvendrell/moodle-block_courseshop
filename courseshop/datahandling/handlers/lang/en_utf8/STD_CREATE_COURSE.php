...
products after proper authenticaton.</p>
<p><a href=\"{$CFG->wwwroot}/course/view.php?id=$a->id\">Direct access to your cousespace</a></p>
';

$string['productiondata_assign_sales'] = '
<p><b>Payement has been received</b></p>
<p>Customer $c->username has been assigned a new course {$a->fullname} with id {$a->shortname}.</p>

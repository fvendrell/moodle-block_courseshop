...
class shop_handler_PK_3_SECURITE extends shop_handler{
    ...
    function produce_postpay(&$data){
        ...
        foreach($this->courseidnumbers as $courseidnumber){
	        if ($course = get_record('course', 'idnumber', $courseidnumber)){
    			...
    			courseshop_trace("[{$data->transactionid}] Post Pay Process : PK_3_SECURITE Failure for course ID number $courseidnumber.");
        ...
        $productiondata->private = get_string('productiondata_assign_private', 'TRAIN_AMF', $maincourse->id, $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
        $productiondata->salesadmin .= get_string('productiondata_assign_sales', 'TRAIN_AMF', $maincourse->id, $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
    	...
    	courseshop_trace("[{$data->transactionid}] Post Pay Process : PK_3_SECURITE Completed.");
        return $productiondata;
    }

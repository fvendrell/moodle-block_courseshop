...
class shop_handler_TRAIN_AMF_4 extends shop_handler{
    ...
    function produce_prepay(&$data){
        ...
        if (!$data->user = get_record('user', 'username', $newuser->username)){
            ...
            $productiondata->public = get_string('productiondata_public', 'TRAIN_AMF_2', '', $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
            $a->username = $newuser->username;
            $a->password = $password;
            $productiondata->private = get_string('productiondata_private', 'TRAIN_AMF_2', $a, $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
            $productiondata->salesadmin = get_string('productiondata_sales', 'TRAIN_AMF_2', $newuser->username, $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
        } else {
    ...
    function produce_postpay(&$data){
        ...
        $productiondata->public = get_string('productiondata_assign_public', 'TRAIN_AMF_2', '', $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
        $productiondata->private = get_string('productiondata_assign_private', 'TRAIN_AMF_2', $course->id, $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');
        $productiondata->salesadmin = get_string('productiondata_assign_sales', 'TRAIN_AMF_2', $course->id, $CFG->dirroot.'/blocks/courseshop/datahandling/handlers/lang/');

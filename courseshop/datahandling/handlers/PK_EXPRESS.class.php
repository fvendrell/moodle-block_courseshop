...
class shop_handler_PK_EXPRESS{
    ...
    function produce_postpay(&$data){
        ...
        if ($course = get_record('course', 'idnumber', $this->courseidnumber)){
			...
			courseshop_trace("[{$data->transactionid}] Post Pay Process : PK_EXPRESS Failure for course ID number {$this->courseidnumber}.");
    	...
    	courseshop_trace("[{$data->transactionid}] Post Pay Process : PK_EXPRESS Completed.");
        return $productiondata;
    }

<?php //$Id: formelement_choosefile.php,v 1.1 2011-06-02 17:07:54 vf Exp $
global $CFG;
require_once "$CFG->libdir/form/group.php";

// register this new element in QuickForm
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES']['choosefile'] = array($CFG->dirroot.'/blocks/courseshop/forms/formelement_choosefile.php','HTML_QuickForm_group');
...
class MoodleQuickForm_choosefile extends MoodleQuickForm_group
{
    ...
    */
    ...
    function _createElements() {
        ...
        $this->_elements[1] =& MoodleQuickForm::createElement('button', 'popup', get_string('chooseafile', 'block_courseshop') .' ...');
        ...
        $url="/block/courseshop/file.php?id={$blockid}&pinned={$pinned}&choose=".$choose;
        ...
        $buttonattributes = array('title' => get_string('chooseafile', 'block_courseshop'),
